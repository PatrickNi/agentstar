...
function calendar(scwEle,scwSourceEle)
{
                             ...
                             if (scwDisabled ||
                                ...
                                {scwRows.childNodes[j].onclick=scwCellOutput;
                                 ...
                                 scwCell.className=
                                     (scwShowDate.getMonth()!=scwCurMonth)
                                        ?'scwCellsExMonth'
                                        :(scwBlnFullInputDate && scwShowDate.toDateString()==scwSeedDate.toDateString())
                                            ?'scwInputDate'
                                            :(scwBlnFullInputDate && scwShowDate.toDateString()==scwDateNow.toDateString()) //today
                                            		?'scwCellsHover'
                                            		:(scwShowDate.getDay()%6==0)
                                                		?'scwCellsWeekend'
                                                		:'scwCells';
