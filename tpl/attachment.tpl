		...
		<table align="center" class="graybordertable" width="100%" cellpadding="1" cellspacing="1">
			...
			<tr align="center" class="greybg">
				<td align="left" style="font-size:16px " colspan="2">
					<span class="highyellow">ItemID: {$itemid}</span>&nbsp;&nbsp;&nbsp;
					<span class="highyellow">Type: {$itemtype}</span>
					{if $itemdesc != ""} &nbsp;&nbsp;&nbsp;<span class="highyellow">Description: {$itemdesc}</span>{/if}
				</td>
			</tr>
			<tr align="center">
				<td class="roweven" align="left" colspan="2"><input type="file" size="160" name="uploadFile"
						value="Browse">
				...
				<td>
					<table border="0" cellpadding="1" cellspacing="1" width="100%">
						...
						<tr class="roweven" align="left">
							<td width="2%"><input type="radio" name="id" value="{$id}"
									onClick="setNameBox({$id}, this)"></td>
							<td><input type="text" name="new_{$id}" value="" disabled>&nbsp;
								<input type="submit" id="ch_{$id}" name="Change" value="Change"
									style="font-weight:bold;" disabled="disabled">&nbsp;
								<input type="submit" id="del_{$id}" name="Delete" value="Delete"
									style="font-weight:bold;" disabled="disabled">
							</td>
							<td><a
									href="{if $arr.his}http://110.143.32.230:8080/download/{else}/download/{/if}{$arr.url}">{$arr.file}</a>
							</td>
							<td>{$arr.time}</td>
						</tr>
						{/foreach}
