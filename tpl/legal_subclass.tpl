...
<title>Agent Star - Legal SubClass</title>
</head>
...
<table align="center" class="graybordertable" width="100%" border="0" cellpadding="1" cellspacing="1">
	<tr align="left"  class="bordered_2">
	  <td colspan="2">	  	&nbsp;&nbsp;
		<input type="button" value="Go back to Category" style="font-weight:bold;" onClick="javascrtipt:this.form.action='legal_category.php';this.form.submit();">&nbsp;&nbsp;
	  	&nbsp;&nbsp;<span class="highlighttext">Category: {$category}</span>	  </td>
	</tr>
	<tr align="center"  class="greybg" >
		<td class="whitetext" colspan="2" style="padding:3 ">Legal SubClass Setting
