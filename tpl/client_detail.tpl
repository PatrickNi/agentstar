      ...
      <td width="70%" valign="top">
          <table align="center" width="100%">
              ...
              <tr>
                ...
                <td align="left" width="72%" class="roweven">
                        <select name="t_m" class="text">
                                <option value="married" {if $arr.married == 'married'} selected {/if} >结婚(Married)</option>
                                <option value="divorce" {if $arr.married == 'divorce'} selected {/if}>离婚(Divorce)</option>
                                <option value="never_married" {if $arr.married == 'never_married'} selected {/if}>未婚(Never Married)</option>
                                <option value="separated" {if $arr.married == 'separated'} selected {/if}>分居(Separated)</option>
                                <option value="defacto" {if $arr.married == 'defacto'} selected {/if}>同居(Defacto Relationship)</option>
                        </select>
                </td>
              <tr>    
              ...
              <tr>
                ...
                <td align="left" width="72%" class="roweven"><!--internet, Australian Newspaper,Education Seminar锟斤拷Passby, Friends, other-->
