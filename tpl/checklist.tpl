            ...
            <tr align="center" class="roweven">
                ...
                <td>
                    ...
                    <span style="text-decoration: underline; cursor:pointer; "
                        onClick="save_checklist({$id}, 'Active')">Active</span>&nbsp;
                    {elseif $v.status == 'InActive'}
                    <span style="text-decoration: underline; cursor:pointer; "
                        onClick="save_checklist({$id}, 'Active')">ReActive</span>&nbsp;
                    {else}
                    <span style="text-decoration: underline; cursor:pointer; "
                        onClick="save_checklist({$id}, 'InActive')">InActive</span>&nbsp;
                    {/if}
                    <span style="text-decoration: underline; cursor:pointer; "
                        onClick="clone_checklist({$id})">Clone</span>&nbsp;&nbsp;&nbsp;
                    <span style="text-decoration: underline; cursor:pointer; "
                        onClick="save_checklist({$id}, 'Delete')">Delete</span>
                </td>
            </tr>
            {/foreach}
