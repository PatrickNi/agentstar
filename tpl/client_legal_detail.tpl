...
<body>
  ...
  <form method="get" id="form1" name="form1" action="/scripts/client_legal_detail.php" target="_self"
    onSubmit="return isDelete()">
    ...
    <table border="0" width="95%" cellpadding="2" cellspacing="3">
            ...
            <tr align="center" class="greybg">
              ...
              <td align="left" width="10%">
                ...
                <input type="submit" value="Delete" style="font-weight:bold"
                  onClick="this.form.bt_name.value='delete';this.disable=false;">&nbsp;&nbsp;&nbsp;
                {/if}
              </td>
              ...
              <td align="left" width="30%">
                ...
                <input type="button" value="Close &amp; Refresh " style="font-weight:bold"
                  onClick="save_visa(this, true);">
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr align="center" class="greybg">
        <td align="left" style="font-size:16px " colspan="2"
          onClick="javascript:window.location.href='client_legal.php?cid={$cid}'"
          onMouseMove="javascript:this.style.cursor='pointer'; this.style.backgroundColor='#000'" ;
          onMouseOut="javascript:this.style.backgroundColor='#a3a3a3'"> <span class="highyellow">Client: {$client.lname}
            {$client.fname}</span>&nbsp;&nbsp; <span class="highyellow">DoB: {$client.dob}</span>&nbsp;&nbsp;<span
            class="highyellow">Main Visa: {$client.visa_n}-{$client.class_n}, expr: {$client.epdate}</span>&nbsp;&nbsp;
        </td>
      </tr>
      <tr>
        <td width="60%" align="left" valign="top">
          <table border="0" width="100%" cellpadding="3" cellspacing="1">
            ...
            <tr>
              ...
              <td align="left" width="64%" class="roweven"><input type="text" name="t_first" id="t_first" size="30"
                  value='{$dt_arr.vdate}'>
            ...
            <tr>
              ...
              <td align="left" width="64%" class="roweven"><input type="text" name="t_adate" id="t_adate" size="30"
                  value='{$dt_arr.adate}'>
                ...
                <table border="0" cellpadding="1" cellspacing="1" width="100%">
                  ...
                  <tr align="center" class="roweven">
                    <td style="text-decoration:underline; cursor:pointer"
                      onClick="window.open('client_account_detail.php?vid={$vid}&aid={$id}&cid={$cid}&typ=legal','_blank', 'alwaysRaised=yes,height=500, width=800,location=no,scrollbars=yes')">
                      {$arr.step|ucwords}</td>
                    <td align="right">{$arr.dueamt|string_format:"%.2f"}</td>
                    <td align="right">{$arr.gst|string_format:"%.2f"}</td>
                    <td align="right"><span style="text-decoration:underline; cursor:pointer;"
                        onClick="window.open('client_payment.php?aid={$id}','_blank', 'alwaysRaised=yes,height=500,width=800,location=no,scrollbars=yes')">{$arr.paid|string_format:"%.2f"}</span>
                    </td>
                    <td>{$arr.party|ucwords}</td>
                    <td align="right">{$arr.dueamt_3rd|string_format:"%.2f"}</td>
                    <td align="right">{$arr.gst_3rd|string_format:"%.2f"}</td>
                    <td align="right"><span style="text-decoration:underline; cursor:pointer;"
                        onClick="window.open('client_spand.php?aid={$id}','_blank', 'alwaysRaised=yes,height=500,width=800,location=no,scrollbars=yes')">{$arr.spand|string_format:"%.2f"}</span>
                    </td>
                    <td align="right">
                  ...
                  <tr align="center" class="roweven">
                    <td colspan="9" align="center">
                      ...
                      <input type="button" value="Add new"
                        onclick="window.open('client_account_detail.php?cid={$cid}&vid={$vid}&typ=legal','_blank', 'alwaysRaised=yes,height=500,width=800,location=no,scrollbars=yes')" />
                      {/if}
                    </td>
                  </tr>
                </table>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr class="greybg">
                <td colspan="4" class="whitetext" align="center">Process &nbsp;
                  {if $vid > 0 }
                  <input type="button" value="add new" style="font-weight:bold"
                    onClick="window.open('client_legal_process.php?vid={$vid}&cid={$cid}&isNew=1','_blank','alwaysRaised=yes,height=500,width=800, location=no')">
                  {/if}
                </td>
              </tr>
              <tr align="center" class="totalrowodd">
              ...
              <tr align="left" class="roweven">
                <td class="border_1"><span style="font-size:16px;font-weight:bolder; color:#990000">{if $arr.done eq
                    1}&radic;{else}?{/if}</span>{$arr.date}</td>
                <td class="border_1"><span style="cursor:pointer; text-decoration:underline;"
                    onClick="window.open('client_legal_process.php?vid={$vid}&pid={$arr.pid}&cid={$cid}','_blank','alwaysRaised=yes,height=500,width=800, location=no')">{$arr.subject}</span>
                </td>
                <td class="border_1"><img src="../images/arr_down.gif" style="cursor:pointer"
                    onClick="window.open('client_legal_process.php?vid={$vid}&pid={$arr.pid}&cid={$cid}&isNew=1&isOther=1','_blank','alwaysRaised=yes,height=500,width=800, location=no')">
                </td>
              </tr>
              {/foreach}
            </table>
