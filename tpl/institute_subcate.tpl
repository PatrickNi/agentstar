...
<table align="center" class="graybordertable" width="100%" border="0" cellpadding="1" cellspacing="1">
	<tr align="left"  class="bordered_2">
	  <td colspan="2">	  	&nbsp;&nbsp;
		<input type="button" value="Go back to Category" style="font-weight:bold;" onClick="javascrtipt:this.form.action='institute_category.php';this.form.submit();">&nbsp;&nbsp;
	  	&nbsp;&nbsp;<span class="highlighttext">Category: {$category}</span>	  </td>
	</tr>
	<tr align="center"  class="greybg" >
		<td class="whitetext" colspan="2" style="padding:3 ">Institute Sub Category Setting
	...
	<tr>
		<td align="center" valign="top">
			<table  border="0" cellpadding="2" cellspacing="1" width="100%">
				...
				{foreach key=id item=name from=$subclass_arr[$catid]}
...
<div id="editDiv" style="display:{$isNone}">
	<table border="0" width="100%" cellpadding="3" cellspacing="1">
		...
		<tr>
			<td width="50%" align="right" class="rowodd"><strong>Sub Category Name:</strong>&nbsp;&nbsp;</td>
