...
<title>Agent Star - Legal Steps</title>
</head>
...
<table align="center" class="graybordertable" width="100%" cellpadding="1" cellspacing="1" border="0">
	<tr align="left"  class="bordered_2">
	  <td colspan="2"><input type="button" value="Go back to Category" style="font-weight:bold;" onClick="javascrtipt:this.form.action='legal_category.php';this.form.submit();">&nbsp;&nbsp;
  	  &nbsp;&nbsp;<span class="highlighttext">Category: {$category}&nbsp;&nbsp;&nbsp; Subclass: {$subclass}</span>	  </td>
	</tr>
	<tr align="center"  class="greybg" >
		<td class="whitetext" colspan="2" style="padding:3 ">Legal Steps Setting
