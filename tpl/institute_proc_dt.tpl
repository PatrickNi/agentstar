...
<input type="hidden" name="pid" value="{$pid}">
	<table border="0" width="100%" cellpadding="3" cellspacing="1">
		...
		<tr>
			...
			<td align="left" width="84%" class="roweven"><input type="text" name="t_date" value="{$dt_arr.date}" size="30" id="t_date" >
		...
		<tr>
			...
			<td align="left" width="84%" class="roweven"><input type="text" name="t_due" id="t_due" value="{$dt_arr.due}" size="30">
