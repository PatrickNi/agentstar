        ...
        <table align="center" class="graybordertable" width="100%" cellpadding="1" cellspacing="1" border="0"
            ...
            <tr align="center" class="roweven" id="app_item_{$id}">
                ...
                <td width="40%" align="left">
                    <span onclick="widget_tip(this, {$id}, 'edit')">{if $v.tip != ''}{$v.tip}{else}No tips
                        found{/if}</span>
                </td>
                <td style="vertical-align: top;" width="5%">
                    <a href="#"
                        onClick="window.open('/scripts/attachment.php?item={$v.meta_id}&type=checklist-visa&desc={$v.tit}','_blank', 'alwaysRaised=yes,resizable=yes,scrollbars=yes,width='+ screen.width*6/7 +',height=' + screen.height*4/7)">Upload</a>
                </td>
            </tr>
            {/foreach}
